...
function resetBg_() {
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://cdn.aimiliy.top/backImg/girl_grass_city_213102_2560x1440.webp);
